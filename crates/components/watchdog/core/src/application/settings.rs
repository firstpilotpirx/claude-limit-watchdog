//! User-facing settings — pure value object.
//!
//! No serialization derives, no IO: the YAML on-disk format lives in the
//! `settingspersistence/yaml` adapter together with its DTO + mapper.
